...
export default {
  ...
  computed:{
    listaAvisos(){
      let me = this;
      let url = '/buscador?filtro='+this.filtro+'&busqueda='+this.busqueda;
      axios.get(url)
            .then((response)=>{
      ...
      console.log(`computed function con estos datos : ${this.filtro} ${this.busqueda}`)
    }
  },
}
</script>