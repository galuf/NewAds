              ...
              <div class="row">
                  ...
                  <div class="col-12 col-sm-10 form-group">
                      <select v-model='provincia_id' name="provincia" id="option" class="form-control">
                        ...
                        <option v-for='provincia in provincias' :value="provincia.id" v-text="provincia.nombre"></option>   
                      </select>
                  </div>
              </div>
              ...
              <div class="row">
                  ...
                  <div class="col-12 col-sm-10 form-group">
                    <select v-model='distrito_id' name="distrito" id="option" class="form-control">
                        ...
                        <option v-for='distrito in distritos' :value="distrito.id" v-text="distrito.nombre"></option>   
                      </select>    
                  </div>
              </div>
              <div class="row">
